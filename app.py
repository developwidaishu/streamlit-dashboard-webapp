...
st.markdown("This application is a streamlit dashboard to analyse the sentiments of tweets 🐦 ")
#st.markdown("## My First interactive Dashboard")
st.sidebar.markdown("This application is a streamlit dashboard to analyse the sentiments of tweets 🐦 ")
...
#adding pie charats and histograms

st.sidebar.markdown('### Number of tweets by sentiment')
select=st.sidebar.selectbox('Visualization type',['Histogram','Pie Chart'],key=1)

#functionality for the histogram and pie selections
...
if not st.sidebar.checkbox("Close",True,key=1):
    st.markdown("## Tweets location based on tome of day")
